"""
Apache 로그 파서 모듈
Apache access log를 파싱하여 구조화된 데이터로 변환
"""
import re
...
class ApacheParser:
    ...
    def __init__(self, log_format: str = "combined"):
        ...
        Args:
            log_format: 로그 포맷 ("combined" 또는 "common")
        """
        self.log_format = log_format
        self.pattern = self.COMBINED_PATTERN if log_format == "combined" else self.COMMON_PATTERN
        self.parsed_count = 0
        self.error_count = 0
    ...
    def parse_line(self, line: str) -> Optional[Dict]:
        ...
        try:
            ...
            parsed_log = {
                ...
                'http_referer': groups.get('http_referer', '-') if groups.get('http_referer') != '-' else None,
    ...
    def _parse_timestamp(self, time_str: str) -> datetime:
        ...
        """
        try:
            # Apache 로그 형식: 12/Oct/2024:06:25:24 +0000
